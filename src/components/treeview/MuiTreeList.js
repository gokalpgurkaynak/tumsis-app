                ...
                if (listItem._shouldRender) {
                    return (
                      <CSSTransition 
                        key={i}  
                        classNames={{
                            enter: this.props.classes["tree-list-enter"],
                            exit: this.props.classes["tree-list-leave"]
                        }}
                        timeout={{exit:300, enter:150}}>
                        <ListItem
                            key={'treeListItem-' + i}
                            ...
                            onClick={()=> {
                              ...
                              <ListItemIcon>
                                {getLeftIcon(listItem, this.props.useFolderIcons)}
                              </ListItemIcon>
                              <ListItemText primary={listItem._primaryText} />
                              <ListItemSecondaryAction>
                                {(!listItem.children) ? null : (expandedListItems.indexOf(i) === -1) ? <OpenIcon /> : <CloseIcon />}
                              </ListItemSecondaryAction>
                            </ListItem>
                      </CSSTransition>
                    )
